export const moviedata = [
    ...
    },
    {
        ...
        posterUrl: "https://m.media-amazon.com/images/M/MV5BMTViMDJlYzEtOTUxNi00ZTU5LWI5MTYtMGViNTQ4NTVkYTMyXkEyXkFqcGdeQXVyMzAzNTY3MDM@._V1_.jpg",
        rate: 4.2,
        description:
    ...
    },
    {
        ...
        rate: 4.2,
        description:
            "Set within a year after the events of Batman Begins (2005), Batman, Lieutenant James Gordon, and new District Attorney Harvey Dent successfully begin to round up the criminals that plague Gotham City, until a mysterious and sadistic criminal mastermind known only as the Joker appears in Gotham",
    ...
    },
    {
        ...
        title: "Dexter",
        posterUrl:
            "https://fr.web.img6.acsta.net/pictures/21/11/02/17/27/3558660.jpg",
        rate: 4.2,
        description:
...

    {
        ...
        title: "The Mentalist",
        posterUrl:
            "https://fr.web.img2.acsta.net/pictures/19/05/22/16/28/0961123.jpg",
        rate: 4.7,
        description:
            "A famous psychic outs himself as a fake, and starts working as a consultant for the California Bureau of Investigation so he can find Red John, the madman ....",
